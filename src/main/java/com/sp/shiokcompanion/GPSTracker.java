    ...
    public class GPSTracker extends Service implements LocationListener
    {
        ...
        public Location getLocation() {
            ...
            try {
                ...
                if (!isGPSEnabled && !isNetworkEnabled) //no network provider is enabled, prompt user to enable location services
        ...
        //function to stop using GPS listener
        ...
        {
            int permissionState1 = ActivityCompat.checkSelfPermission(
                    mContext, Manifest.permission.ACCESS_FINE_LOCATION);
            int permissionState2 = ActivityCompat.checkSelfPermission(
        ...
        public void showEnablePermissionAlert()
        {
            ...
            alertDialog.setTitle("Location Permission Settings"); //setting dialog title
            alertDialog.setMessage("Map Location Permission is not enabled. "+"Do you want to go to settings menu?"); //setting dialog message
            ...
            alertDialog.setNegativeButton("Cancel", new DialogInterface.OnClickListener(){
                public void onClick(DialogInterface dialog, int which) {
                    dialog.cancel(); //when Cancel button is pressed
                }
            });
            alertDialog.show();
        }
                    ...
                    .setPositiveButton("Go to Settings Page To Enable Location Service",
                            new DialogInterface.OnClickListener(){
                                public void onClick (DialogInterface dialog, int id){
                                    ...
                                    mContext.startActivity(callGPSSettingIntent); //go to location services setting
                                }
                            });
